...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05998f90_hasScoped_true_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(271);
...
/* scopeId */
var __vue_scopeId__ = "data-v-05998f90"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05998f90_hasScoped_true_preserveWhitespace_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__["a" /* default */],
...
var update = __webpack_require__(21)("1b4ccb60", content, true, {});
...
// module
exports.push([module.i, ".eas-box[data-v-05998f90]{border-radius:0;border:0}.eas-title[data-v-05998f90]{background:#62a8ea;padding-top:13px;padding-bottom:11px}.eas-content[data-v-05998f90]{padding:40px}.eas-button[data-v-05998f90]{padding:9px 24px;border-radius:25px}.eas-message[data-v-05998f90]{font-size:16px}.eas-message-info[data-v-05998f90]{color:#333}.eas-message-warning[data-v-05998f90]{color:#d6494b}.c-success[data-v-05998f90]{background-color:#62a8ea}.c-error[data-v-05998f90],.c-warning[data-v-05998f90]{background-color:#d6494b}.c-info[data-v-05998f90]{background-color:#333}.c-text-title[data-v-05998f90]{color:#fff;font-size:16px;font-weight:700}", ""]);
...
exports.default = {
  ...
  computed: {
    ...
    colorTitle: function colorTitle() {
      ...
      return 'c-' + typeMap[type];
    },
    colorContent: function colorContent() {
      var type = this.type;

      if (!type || !typeMap[type]) {
        return '';
      }
      return typeMap[type].indexOf('warning') > -1 ? 'eas-message-warning' : 'eas-message-info';
    },
    confirmButtonClasses: function confirmButtonClasses() {
      var type = this.type;

      var style = typeMap[type];
      if (!type) {
        style = 'primary';
      }
      return 'el-button--' + style + ' ' + this.confirmButtonClass;
    },
    cancelButtonClasses: function cancelButtonClasses() {
      return 'el-button--info ' + this.cancelButtonClass;
    }
  },
